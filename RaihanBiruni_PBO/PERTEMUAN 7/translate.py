...
class FrmTranslator:
    ...
    def aturKomponen(self):
        mainFrame = Frame(self.parent, bd=10, bg="orange")  # Tambahkan warna latar belakang
        mainFrame.pack(fill=BOTH, expand=True)

        # pasang Label
        Label(mainFrame, text='Masukkan teks:').grid(row=0, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Italia:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Rusia:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Korea:').grid(row=6, column=0,
            sticky=W, padx=5, pady=5)
        ...
        Label(mainFrame, text="Raihan Biruni").grid(row=8, column=1, pady=5, padx=5)
    ...
    def onTranslate(self):
        ...
        # menterjemahkan
        hasil = penterjemah.translate(self.txtSumber.get(), src='id', dest='it') 
        hasil2 = penterjemah.translate(self.txtSumber.get(), src='id', dest='ru') 
